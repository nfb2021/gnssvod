...
_SYSTEM_RNX3 = {
    'GPS': {
        "L1": {
            "Pseudorange":
            {"C1C", "C1S", "C1L", "C1X", "C1P", "C1W", "C1Y", "C1M"},
            "Carrierphase":
            {"L1C", "L1S", "L1L", "L1X", "L1P", "L1W", "L1Y", "L1M", "L1N"},
            "Doppler":
            {"D1C", "D1S", "D1L", "D1X", "D1P", "D1W", "D1Y", "D1M", "D1N"},
            "Signal":
            {"S1C", "S1S", "S1L", "S1X", "S1P", "S1W", "S1Y", "S1M", "S1N"},
        ...
        "L2": {
            ...
            "Carrierphase": {
                "L2C", "L2D", "L2S", "L2L", "L2X", "L2P", "L2W", "L2Y", "L2M",
                "L2N"
            },
            "Doppler": {
                "D2C", "D2D", "D2S", "D2L", "D2X", "D2P", "D2W", "D2Y", "D2M",
                "D2N"
            },
            "Signal": {
                "S2C", "S2D", "S2S", "S2L", "S2X", "S2P", "S2W", "S2Y", "S2M",
                "S2N"
            },
            "Frequency": 1227600000
        },  # END OF L2
        "L5": {
            "Pseudorange": {"C5I", "C5Q", "C5X"},
    ...
    'GALILEO': {
        "L1": {
            "Pseudorange": {"C1A", "C1B", "C1C", "C1X", "C1Z"},
        ...
        "L6": {
            "Pseudorange": {"C6A", "C6B", "C6C", "C6X", "C6Z"},
    ...
    'COMPASS': {
        ...
        "L7": {
            "Pseudorange": {"C7I", "C7Q", "C7X", "C7D", "C7P", "C7Z"},
    ...
    'QZSS': {
        "L1": {
            "Pseudorange": {"C1C", "C1S", "C1L", "C1X", "C1Z"},
        ...
        "L5": {
            "Pseudorange": {"C5I", "C5Q", "C5X", "C5D", "C5P", "C5Z"},
        ...
        "L6": {
            "Pseudorange": {"C6S", "C6L", "C6X", "C6E", "C6Z"},
...
def _system_name(satellite_list):
    system = [
        "GPS" if sv[0] == "G" else "GLONASS" if sv[0] == "R" else "COMPASS" if
        sv[0] == "C" else "GALILEO" if sv[0] == "E" else "QZSS" if sv[0] == "J"
        else "IRNSS" if sv[0] == "I" else "SBAS" if sv[0] == "S" else "UNKNOWN"
        for sv in satellite_list
    ]
    return system
