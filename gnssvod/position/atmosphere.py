...
"""
import numpy as _np
from gnssvod.geodesy.coordinate import cart2ell as _cart2ell
from gnssvod.funcs.date import datetime2doy as _datetime2doy
...
def tropospheric_delay(x, y, z, elevation, epoch):
    ...
    # Average values
    ave_params = _np.array([[1013.25, 299.65, 26.31, 6.30e-3, 2.77],
    ...
    # seasonal variations
    sea_params = _np.array([[0.00, 0.00, 0.00, 0.00e-3, 0.00],
